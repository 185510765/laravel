...
// 是否是线上测试环境打包 是的话打包测试环境 否则打包线上真实环境
const debug_trial = true; // true 测试包  false 正式包
...
const setting = {
  ...
  // 生产环境构建文件的目录名 自己添加
  outputDir: debug_trial ? 'dist_trial' : 'dist_produ',
  // 服务器打包接口域名
  webpackDomain: debug_trial
